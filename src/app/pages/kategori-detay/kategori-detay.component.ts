...
export class KategoriDetayComponent implements AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    const tumUrunler: Record<string, Record<string, Urun[]>> = {
      ...
      tr: {
        salads: [
          { isim: 'Burrata', aciklama: 'karışık salata, çeri domates, avokado, burrata, baharatlar', fiyat: '14 lv', resim: 'burrata.png' },
          { isim: 'Sezar', aciklama: 'marul, tavuk fileto, kiraz domates, kruton, parmesan, sos', fiyat: '12 lv', resim: 'cezar.png' },
          { isim: 'Nitsa', aciklama: 'marul, tavuk fileto, kiraz domates, kruton, parmesan, sos', fiyat: '12 lv', resim: 'nitsa.png' },
          { isim: 'Fırında peynirli kinoa', aciklama: 'karışık salatalar, domates, salatalık, kinoa, peynir, sos', fiyat: '12 lv', resim: 'kinoa.png' },
          { isim: 'Yunan salatası', aciklama: 'domates, salatalık, közlenmiş biber peyniri, bruschetta, zeytin ezmesi', fiyat: '11 lv', resim: 'greek-salad.png' },
          { isim: 'Gelenek', aciklama: 'közlenmiş biber, patlıcan, domates, peynir', fiyat: '11 lv', resim: 'tradition.png' },
          { isim: 'Çoban salatası', aciklama: 'domates, salatalık, taze biber, mantar, jambon, kaşar, peynir, yumurta, zeytin', fiyat: '12 lv', resim: 'coban.png' },
          { isim: 'Shopska salata', aciklama: 'domates, salatalık, taze biber, peynir', fiyat: '10 lv', resim: 'shopska.png' },
          { isim: 'Kapreze', aciklama: 'domates, mozarella, fesleğen pesto', fiyat: '11 lv', resim: 'kapreze.png' }
        ],
        starters: [
        ...
        softdrinks: [
          { isim: 'Cola, Fanta, Sprite, Schweps', aciklama: '250 ml.', fiyat: '2.50 lv'},
          { isim: 'Schweps Soda', aciklama: '250 ml.', fiyat: '2.20 lv'},
          { isim: 'Cappy', aciklama: '250 ml.', fiyat: '3 lv'},
          { isim: 'Buzlu çay', aciklama: '250 ml.', fiyat: '3 lv'},
          { isim: 'Maden suyu', aciklama: '250 ml.', fiyat: '2 lv'},
          { isim: 'Maden suyu', aciklama: '1000 ml.', fiyat: '3,20 lv'},
          { isim: 'Ayran', aciklama: '250 ml.', fiyat: '2 lv'},
          { isim: 'Ayran', aciklama: '1000 ml.', fiyat: '6 lv'},
          { isim: 'Red Bull', aciklama: '250 ml.', fiyat: '5.50 lv'},
          { isim: 'Fresh', aciklama: '250 ml.', fiyat: '5,80 lv'},
        ...
        whisky: [
          ...
          { isim: 'Jameson', aciklama: '50 ml.', fiyat: '4.40 lv'},
          ...
          { isim: 'Glenfidich 12 g.', aciklama: '50 ml.', fiyat: '12 lv'},
          { isim: 'Dumpling 15 g.', aciklama: '50 ml.', fiyat: '12 lv'},
        ],
        vodkas: [
          {isim:'Savoy', aciklama:'50 ml.', fiyat:'2.80 lv'},
          {isim: 'Absolut', aciklama: '50 ml.', fiyat:'3.80 lv'},
          {isim: 'Rus Standardı', aciklama: '50 ml.', fiyat:'3.80 lv'},
          {isim: 'Finlandiya', aciklama: '50 ml.', fiyat:'3.80 lv'},
          {isim: 'Belvedere', aciklama: '50 ml.', fiyat: '9 lv'},
          {isim: 'Beluta', aciklama: '50 ml.', fiyat: '9 lv'},
          {isim: 'Greygus', aciklama: '50 ml.', fiyat:'8.50 lv'},
        ],
        beer: [
          { isim: 'Shumensko pivo', aciklama: '500 ml.', fiyat: '3.50 lv'},
          { isim: 'Shumensko pivo', aciklama: '330 ml.', fiyat: '2.50 lv'},
          { isim: 'Pirinsko', aciklama: '500 ml.', fiyat: '3 lv'},
        ...
        wine: [
          ...
          { isim: 'Syrah', aciklama: 'Starosel 750 ml.', fiyat: '27 lv'},
          ...
          { isim: 'Rosé', aciklama: 'Contemplation 750 ml.', fiyat: '26 lv'},
          { isim: 'Savignon Blanc', aciklama: 'Contemplation 750 ml.', fiyat: '26 lv'},
          { isim: 'La Blanc', aciklama: 'Katarhina Estate 750 ml.', fiyat: '35 lv'},
          { isim: 'La Rosé', aciklama: 'Katarhina Estate 750 ml.', fiyat: '35 lv'},
          { isim: 'Silver Eindhoven', aciklama: 'Midalidare 750 ml.', fiyat: '28 lv'},
          ...
          { isim: 'Savignon Blanc', aciklama: 'Rongopai 750 ml.', fiyat: '36 lv'},
          ...
          { isim: 'Rosé', aciklama: 'Pentagram 750 ml.', fiyat: '18 lv'},
          { isim: 'Savignon Blanc', aciklama: 'Pentagram 750 ml.', fiyat: '18 lv'},
          { isim: 'Traminer', aciklama: 'Pentagram 750 ml.', fiyat: '20 lv'},
          { isim: 'Savignon Blanc Black Label', aciklama: 'Babych Malboro 750 ml.', fiyat: '60 lv'},
          { isim: 'Savignon Blanc', aciklama: 'Babich Malboro 750 ml.', fiyat: '48 lv'},
          { isim: 'Martini asti', aciklama: 'Köpüklü şarap 750 ml.', fiyat: '40 lv'},
          { isim: 'Moet Chandon', aciklama: 'Köpüklü şaraplar 750 ml.', fiyat: '160 lv'},
          { isim: 'Savignon Blanc', aciklama: 'Pomorie Cellar 1000/750 ml.', fiyat: '14/8 lv'},
          { isim: 'Syrah', aciklama: 'Pomorie Cellar 1000/750 ml.', fiyat: '14/8 lv'},
          { isim: 'Rosé', aciklama: 'Pomorie Cellar 1000/750 ml.', fiyat: '14/8 lv'},
          { isim: 'Şarap kadehi', aciklama: 'Pomorie Cellar 250 ml.', fiyat: '4 lv'},
        ]
        },

      en: {
        salads: [
          { isim: 'Burrata', aciklama: 'salad mix, cherry tomatoes, avocado, burrata, spices', fiyat: '14 lv', resim: 'burrata.png' },
          { isim: 'Caesar', aciklama: 'iceberg, chicken fillet, cherry tomatoes, croutons, parmesan, dressing', fiyat: '12 lv', resim: 'cezar.png' },
          { isim: 'Nitsa', aciklama: 'lettuce, tomatoes, cucumbers. tuna, egg. fresh onion, olives', fiyat: '12 lv', resim: 'nitsa.png' },
          { isim: 'Quinoa with baked cheese', aciklama: 'mixed salads, tomatoes, cucumbers, quinoa, cheese, dressing', fiyat: '12 lv', resim: 'kinoa.png' },
          { isim: 'Greek salad', aciklama: 'tomatoes, cucumbers, roasted pepper cheese, bruschetta, olive paste', fiyat: '11 lv', resim: 'greek-salad.png' },
          { isim: 'Tradition', aciklama: 'roasted pepper, eggplant, tomatoes, cheese', fiyat: '11 lv', resim: 'tradition.png' },
          { isim: 'Shepherds salad', aciklama: 'tomatoes, cucumbers, fresh pepper, mushrooms, ham, yellow cheese, cheese, egg, olives', fiyat: '12 lv', resim: 'coban.png' },
          { isim: 'Shopska salad', aciklama: 'tomatoes, cucumbers, fresh pepper, cheese', fiyat: '10 lv', resim: 'shopska.png' },
          { isim: 'Caprese', aciklama: 'tomatoes, mozzarella, basil pesto', fiyat: '11 lv', resim: 'kapreze.png' }
        ],
        starters: [
        ...
        softdrinks: [
          ...
          { isim: 'Schweps Soda', aciklama: '250 ml.', fiyat: '2.20 lv'},
          { isim: 'Cappy', aciklama: '250 ml.', fiyat: '3 lv'},
          { isim: 'Iced tea', aciklama: '250 ml.', fiyat: '3 lv'},
          { isim: 'Mineral water', aciklama: '250 ml.', fiyat: '2 lv'},
          { isim: 'Mineral water', aciklama: '1000 ml.', fiyat: '3.20 lv'},
          { isim: 'Ayrian', aciklama: '250 ml.', fiyat: '2 lv'},
          { isim: 'Ayrian', aciklama: '1000 ml.', fiyat: '6 lv'},
          { isim: 'Red Bull', aciklama: '250 ml.', fiyat: '5.50 lv'},
          { isim: 'Fresh', aciklama: '250 ml.', fiyat: '5.80 lv'},
        ...
        vodkas: [
          {isim:'Savoy', aciklama:'50 ml.', fiyat:'2.80 lv'},
          {isim: 'Absolut', aciklama: '50 ml.', fiyat:'3.80 lv'},
          {isim: 'Russian Standard', aciklama: '50 ml.', fiyat:'3.80 lv'},
          {isim: 'Finland', aciklama: '50 ml.', fiyat:'3.80 lv'},
          {isim: 'Belvedere', aciklama: '50 ml.', fiyat:'9 lv'},
          {isim: 'Beluta', aciklama: '50 ml.', fiyat:'9 lv'},
          {isim: 'Greygus', aciklama: '50 ml.', fiyat:'8.50 lv'},
        ],
        ...
        wine: [
          ...
          { isim: 'La Blanc', aciklama: 'Katarhina Estate 750 ml.', fiyat: '35 lv'},
          { isim: 'La Rosé', aciklama: 'Katarhina Estate 750 ml.', fiyat: '35 lv'},
          { isim: 'Silver Angel', aciklama: 'Midalidare 750 ml.', fiyat: '28 lv'},
          { isim: 'Cabernet Sauvignon', aciklama: 'Midalidare 750 ml.', fiyat: '28 lv'},
          { isim: 'Sauvignon Blanc', aciklama: 'Cycle 750 ml.', fiyat: '18 lv'},
          { isim: 'Cabernet Franc', aciklama: 'Cycle 750 ml.', fiyat: '18 lv'},
          { isim: 'Savignon Blanc', aciklama: 'Nelson Cliff 750 ml.', fiyat: '35 lv'},
          ...
          { isim: 'Savignon Blanc Black Label', aciklama: 'Babych Malboro 750 ml.', fiyat: '60 lv'},
          { isim: 'Savignon Blanc', aciklama: 'Babich Malboro 750 ml.', fiyat: '48 lv'},
          { isim: 'Martini asti', aciklama: 'Sparkling wine 750 ml.', fiyat: '40 lv'},
          { isim: 'Moet Chandon', aciklama: 'Sparkling wines 750 ml.', fiyat: '160 lv'},
          { isim: 'Savignon Blanc', aciklama: 'Pomorie Cellar 1000/750 ml.', fiyat: '14/8 lv'},
          { isim: 'Syrah', aciklama: 'Pomorie Cellar 1000/750 ml.', fiyat: '14/8 lv'},
          { isim: 'Rosé', aciklama: 'Pomorie Cellar 1000/750 ml.', fiyat: '14/8 lv'},
          { isim: 'Wine glass', aciklama: 'Pomorie Cellar 250 ml.', fiyat: '4 lv'},
        ]
      },
      bg: {
        salads:[
          { isim: 'Бурата', aciklama: 'микс салати, чери домати, авокадо, бурата, подправки', fiyat: '14 лв', resim: 'burrata.png' },
          { isim: 'Цезар с пиле', aciklama: 'айсберг, пилешко филе, чери домати, крутони, пармезан, дресинг', fiyat: '12 лв', resim: 'cezar.png' },
          { isim: 'Ница', aciklama: 'маруля, домати, краставици. риба тон, яйце. пресен лук, маслини', fiyat: '12 лв', resim: 'nitsa.png' },
          { isim: 'Киноа със запечено сирене', aciklama: 'микс салати, домати, краставици, киноа, сирене, дресинг', fiyat: '12 лв', resim: 'kinoa.png' },
          { isim: 'Гръцка салата', aciklama: 'домати, краставици, печен пипер сирене, брускета, маслинова паста', fiyat: '11 лв', resim: 'greek-salad.png' },
          { isim: 'Традиция', aciklama: 'печен пипер, патладжан домати, сирене', fiyat: '11 лв', resim: 'tradition.png' },
          { isim: 'Овчарска салата', aciklama: 'домати, краставици, пресен пипер, гъби, шунка, кашкавал, сирене, яйце, маслини', fiyat: '12 лв', resim: 'coban.png' },
          { isim: 'Шопска салата', aciklama: 'домати, краставици, пресен пипер, сирене', fiyat: '10 лв', resim: 'shopska.png' },
          { isim: 'Капрезе', aciklama: 'домати, моцарела, босилково песто', fiyat: '10 лв', resim: 'kapreze.png' }
        ],
        starters: [
        ...
        softdrinks: [
          { isim: 'Кола, Фанта, Спрайт, Швепс', aciklama: '250 мл.', fiyat: '2.50 лв'},
          { isim: 'Швепс Сода', aciklama: '250 мл.', fiyat: '2.20 лв'},
          { isim: 'Капи', aciklama: '250 мл.', fiyat: '3 лв'},
          { isim: 'Студен чай', aciklama: '250 мл.', fiyat: '3 лв'},
          { isim: 'Минерална вода', aciklama: '250 мл.', fiyat: '2 лв'},
          { isim: 'Минерална вода', aciklama: '1000 мл.', fiyat: '3.20 лв'},
          { isim: 'Айрян', aciklama: '250 мл.', fiyat: '2 лв'},
          { isim: 'Айрян', aciklama: '1000 мл.', fiyat: '6 лв'},
          { isim: 'Ред Бул', aciklama: '250 мл.', fiyat: '5.50 лв'},
          { isim: 'Фреш', aciklama: '250 мл.', fiyat: '5.80 лв'},
          { isim: 'Лимонада', aciklama: '400 мл.', fiyat: '...лв'},
        ],
        rakia: [
          { isim: 'Бургаска мускатова', aciklama: '50 мл.', fiyat: '2.80 лв'},
        ...
        whisky: [
          ...
          { isim: 'Джеймсън', aciklama: '50 мл.', fiyat: '4.40 лв'},
          ...
          { isim: 'Гленфидич 12 г.', aciklama: '50 мл.', fiyat: '12 лв'},
          { isim: 'Дъмпъл 15 г.', aciklama: '50 мл.', fiyat: '12 лв'},
        ],
        vodkas: [
          {isim: 'Савой', aciklama: '50 мл.', fiyat:'2.80 лв'},
          {isim: 'Абсолют', aciklama: '50 мл.', fiyat:'3.80 лв'},
          {isim: 'Руский Стандарт', aciklama: '50 мл.', fiyat:'3.80 лв'},
          {isim: 'Финландия', aciklama: '50 мл.', fiyat:'3.80 лв'},
          {isim: 'Белведере', aciklama: '50 мл.', fiyat:'9 лв'},
          {isim: 'Белута', aciklama: '50 мл.', fiyat:'9 лв'},
          {isim: 'Грейгус', aciklama: '50 мл.', fiyat:'8.50 лв'},
        ],
        beer: [
          { isim: 'Шуменско пиво', aciklama: '500 мл.', fiyat: '3.50 лв'},
          { isim: 'Шуменско пиво', aciklama: '330 мл.', fiyat: '2.50 лв'},
          { isim: 'Пиринско', aciklama: '500 мл.', fiyat: '3 лв'},
        ...
        wine: [
          ...
          { isim: 'Розе', aciklama: 'Пентаграм 750 мл.', fiyat: '18 лв'},
          { isim: 'Савиньон Блан', aciklama: 'Пентаграм 750 мл.', fiyat: '18 лв'},
          { isim: 'Траминер', aciklama: 'Пентаграм 750 мл.', fiyat: '20 лв'},
          { isim: 'Савиньон Блан черен етикет', aciklama: 'Бабич Малборо 750 мл.', fiyat: '60 лв'},
          { isim: 'Савиньон Блан', aciklama: 'Бабич Малборо 750 мл.', fiyat: '48 лв'},
          { isim: 'Мартини асти', aciklama: 'Пенливи вина 750 мл.', fiyat: '40 лв'},
          { isim: 'Моет Шандон', aciklama: 'Пенливи вина 750 мл.', fiyat: '160 лв'},
          { isim: 'Савиньон Блан', aciklama: 'Наливно вино Поморийска изба<br>1000/750 мл.', fiyat: '14/8 лв'},
          { isim: 'Сира', aciklama: 'Наливно вино Поморийска изба<br>1000/750 мл.', fiyat: '14/8 лв'},
          { isim: 'Розе', aciklama: 'Наливно вино Поморийска изба<br>1000/750 мл.', fiyat: '14/8 лв'},
          { isim: 'Чаша вино', aciklama: 'Наливно вино Поморийска изба 250 мл.', fiyat: '4 лв'},
        ]
      }
